...
var docDefinition = {
	content: [
		...
		"The following table has nothing more than a body groups array",
		{
			style: "tableExample",
			table: {
				body: {
			...
			table: {
				...
				body: {
					...
					layout: {
						...
						hLineWidth: (index, node) => (index === node.table.body.length ? 0.5 : 0),
					},
				},
			},
		},
		...
		{
			text: [
				"Set keepTogether on the first logical body group to prevent a page break between its physical rows and to keep that first group with the declared header when it fits.",
			],
			color: "gray",
			italics: true,
		},
