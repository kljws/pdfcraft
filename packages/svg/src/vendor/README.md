...
- `renderer/context.cjs` creates isolated state for each render and installs renderer modules.
...
- `svg-to-pdfkit.cjs` normalizes options and orchestrates one render.
